  ...
  >
    <div className="aspect-[4/3] bg-gray-900 overflow-hidden">
      {project.video ? (
        ...
        <img
          src={project.image && project.image.replace('.png', '.webp')}
...
const ProjectsPage = () => {
  return (
    <div
      id="project"
      className="bg-black text-white py-6 px-4 sm:px-6 lg:px-8 z-30"
    >
      <div className="max-w-7xl mx-auto space-y-8 z-30">
        <motion.section
          aria-label="Projects"
